...
- [x] Renderizzare asset CSS/JS/immagini esistenti senza rompere layout.
  ...
  - SEO canonical URL 2026-07-15: layout dinamico e statici locali usano link interni slashless (`/`, `/portfolio`, `/about`, `/contact`); `/index.html`, `/index.php` e alias `.html` fanno 301 verso le URL canoniche; aggiunti canonical/`og:url`, `robots.txt` e `sitemap.xml`. Worker versione `376a6339-70d5-4a2f-9531-0e7c69a8e43f`; suite `edge` 107/107; smoke live su redirect, canonical, robots e sitemap passato.
  - Nota cookie/privacy 2026-07-15: verificato che il sito pubblico non usa cookie, `Set-Cookie`, storage persistente o analytics; aggiunta sovraimpressione informativa "Nessun cookie" senza persistenza del consenso/chiusura. Asset version `20260715-cookie-note`; Pages deploy `https://94fbd4a9.lorenzozanna-ph.pages.dev`; Worker versione `0f0f9868-9486-4749-808a-bb84333117dd`; suite `edge` 108/108; smoke live su nota, asset, assenza `Set-Cookie` e JS senza storage passato.
  - Refinement cookie/privacy 2026-07-15: la nota non deve aprirsi automaticamente. Il footer espone `Cookie privacy` vicino al copyright, apre il pannello solo su click e lo richiude senza usare cookie/session/local storage. Asset version `20260715-cookie-footer`; Pages deploy `https://c5cf203c.lorenzozanna-ph.pages.dev`; Worker versione `ba34087d-40d4-472d-8433-06ae336575a9`; suite `edge` 108/108; smoke live su nota nascosta, trigger footer, asset e assenza storage passato.
